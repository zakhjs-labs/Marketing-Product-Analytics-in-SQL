WITH cancelled_orders AS (
    ...
    FROM
        ...
        AND creation_time >= '2022-09-01' AND creation_time < '2022-09-08') t
    ...
    SELECT ads_campaign, user_id, AVG(order_price) AS avg_price
    FROM camp1_orders
...
SELECT ads_campaign, ROUND(AVG(avg_price), 2) AS avg_check
FROM camp1_price
